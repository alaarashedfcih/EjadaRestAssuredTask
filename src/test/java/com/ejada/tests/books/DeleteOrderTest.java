...
import static com.ejada.controller.BooksController.deleteOrderRequest;
...
public class DeleteOrderTest extends BaseTest {
    ...
    @Test(alwaysRun = true)
    public void books_DeleteOrderTest(){
        Response deleteOrderResponse = deleteOrderRequest(orderID);
